...
const testimonials = [
  {
    name: "Eva Sawyer",
    job: "CEO, Fashworks",
    image: "../concert/images/user1.jpg",
    testimonial:
  ...
  },
  {
    ...
    image: "../concert/images/hollin.jpg",
    testimonial:
  ...
  },
  {
    ...
    image: "../concert/images/user2.jpg",
    testimonial:
  ...
  },
  {
    ...
    job: "Civil Engineer",
    image: "../concert/images/scofield.jpg",
    testimonial:
...
let displayTestimonial = () => {
  testimonialContainer.innerHTML = `
    ...
    <img src="${testimonials[i].image}" alt="${testimonials[i].image}">
